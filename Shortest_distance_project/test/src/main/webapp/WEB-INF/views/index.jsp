		    ...
		    <div class="mb-3 row">
			    ...
			    <div class="col-md-8">
				    <select name = "developer" class="form-select" class="form-control">
				    	...
				    	<option value="jisoon_dijkstra">지순/다익스트라</option>
				    	<option value="jimin_dijkstra">지민/다익스트라</option>
				    	<option value="jisoon_floyd">지순/플로이드 와샬</option>
				    	<option value= "jimin_spfa">지민/SPFA</option>
				    </select>
			    </div>
			</div>
