...
if __name__ == '__main__':
    station_file = pd.read_excel("User's Path" +"\\SeoulMetro_StationSpacing(202003)_edit.xlsx")
    transfer_station_file = pd.read_excel("User's Path" +"transit_station_distance.xlsx")
